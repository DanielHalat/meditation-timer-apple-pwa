...
export function selectedIdAfterDeletion(remainingPresets, deletedIndex) {
  if (!remainingPresets.length) return null;
  return remainingPresets[Math.min(deletedIndex, remainingPresets.length - 1)].id;
}
